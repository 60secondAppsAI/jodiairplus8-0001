						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div id="app">
								  ...
								  <base-input label="Manufacturer" type="text" placeholder="Enter Manufacturer" v-model="aircraftToAdd.manufacturer"></base-input>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Manufacturer</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Manufacturer" type="text" placeholder="Enter Manufacturer" v-model="aircraftDetails.manufacturer"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Seating Capacity</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="SeatingCapacity" type="text" placeholder="Enter SeatingCapacity" v-model="aircraftDetails.seatingCapacity"></input>
																		</div>
						</td>
														</tr>
